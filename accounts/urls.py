...
urlpatterns = [
    ...
    path('manager/rooms/<int:pk>/',views.manager_room_detail_view,name='manager_room_detail'),
    ...
    path('manager/services/<int:pk>/',views.manager_service_detail_view,name='manager_service_detail'),
